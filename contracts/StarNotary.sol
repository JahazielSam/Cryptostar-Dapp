...
contract StarNotary is ERC721 {
        ...
        returns (string memory)
    {
        ...
        Star memory curStar = tokenIdToStarInfo[_tokenId];
        return curStar.name;
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(
            ...
            "Either of the tokens should be of the sender"
        );
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(
            ownerOf(_tokenId) == msg.sender,
            "You should be the owner of the token."
        );
    ...
    // Supporting function to return the owner of the given token
