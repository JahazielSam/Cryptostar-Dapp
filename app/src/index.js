...
const App = {
  ...
  lookUp: async function () {
    ...
    let starName = await lookUptokenIdToStarInfo(tokenId).call({ from: this.account });
...
window.addEventListener("load", async function () {
  if (window.ethereum) {
    ...
    App.web3 = new Web3(new Web3.providers.HttpProvider("https://rinkeby.infura.io/v3/298df63315214b1688a3c2b29e03217d"),);
  }
